	...
	return (
		<div className='App'>
			...
			<div className='button-container'>
				<Button value='True' dispatch={dispatch} correctAnswer={data[state.index].correct_answer} />
				<Button value='False' dispatch={dispatch} correctAnswer={data[state.index].correct_answer}/>
			</div>
		</div>
	);
}
